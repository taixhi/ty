...
For detailed information about command-line options, see the [CLI documentation]([ruff/crates/ty/docs/cli.md](https://github.com/astral-sh/ruff/blob/main/crates/ty/docs/cli.md)).
